export default function Footer() {
  return (
    <footer className="bg-primary text-white py-8 px-6 md:px-12 lg:px-20">
      ...
      {/* Copyright */}
      <div className="max-w-7xl mx-auto mt-6 pt-6 border-t border-white/20 text-center md:text-left">
